...
<br />
        	...
        	<div class="col2">
            	<!-- Featured Products -->
                <div class="clear"><h5 class="small_head">CheckOut</h5></div>
                <!-- Product Listing -->
                <div class="prlisting">
                <font size="+2">
                    <table class="style1">
                        <tr>
                            ...
                            <td>
                                <table class="style1">
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label1" runat="server" Text="Address To Deliever"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                <font size="+2">
                                            <asp:Label ID="Label2" runat="server" Text="Payment Option"></asp:Label>
                    </font>
                                        </td>
                                        <td>
                                            <asp:RadioButtonList ID="RadioButtonList1" runat="server">
                                                <asp:ListItem>Credit Card</asp:ListItem>
                                                <asp:ListItem>Debit/ATM Card</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <font size="+2">
                                        ...
                                        <td>
                                            <asp:Button ID="Button2" runat="server" Text="Proceed To Pay" 
