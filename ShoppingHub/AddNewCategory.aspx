<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewCategory.aspx.cs" Inherits="admin_Default" %>
            ...
            <tr>
                <td colspan="2">
                    <table   border="1">
                        <tr>
                            <td colspan="2">
                               <br /><center>Add New Category</center><br /> </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label3" runat="server" Text="Select Category Picture"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" 
                                    ...
                                    <asp:ListItem Enabled="true">Yes</asp:ListItem>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label7" runat="server" Text="img/catimg/noimg.jpg" 
