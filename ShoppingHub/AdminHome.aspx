...
<div id="wrapper_sec">
         ...
         <table class="style1" border="1">
            <tr>
                <td colspan="2"><br /><center>
                    Welcome Administrator</center><br /></td>
            </tr>
            <tr>
                <td rowspan="3">
                   <center> Add</center></td>
                <td>
                    <asp:LinkButton ID="LinkButton1" runat="server" 
                        PostBackUrl="~/AddNewCategory.aspx">Category</asp:LinkButton>
                </td>
            </tr>
            <tr>
                <td>
    <font color="#FFFFFF" size="+2">
                    ...
                    <asp:LinkButton ID="LinkButton2" runat="server" 
                        PostBackUrl="~/AddNewBrand.aspx">Brand</asp:LinkButton>
     </font>
                </td>
            </tr>
            <tr>
    ...
    <font color="#FFFFFF" size="+2">
                    ...
                    <asp:LinkButton ID="LinkButton3" runat="server" 
                        PostBackUrl="~/AddNewProduct.aspx">Product</asp:LinkButton>
     </font>
                </td>
            </tr>
            <tr>
    ...
    <font color="#FFFFFF" size="+2">
                    ...
                    <asp:LinkButton ID="LinkButton4" runat="server" 
                        PostBackUrl="~/DeleteCategory.aspx">Category</asp:LinkButton>
     </font>
                </td>
            </tr>
            <tr>
    ...
    <font color="#FFFFFF" size="+2">
                    ...
                    <asp:LinkButton ID="LinkButton5" runat="server" 
                        PostBackUrl="~/DeleteBrand.aspx">Brand</asp:LinkButton>
     </font>
                </td>
            </tr>
            <tr>
    ...
    <font color="#FFFFFF" size="+2">
                    ...
                    <asp:LinkButton ID="LinkButton6" runat="server" 
                        PostBackUrl="~/DeleteProduct.aspx">Product</asp:LinkButton>
     </font>
                </td>
            </tr>
            <tr>
                <td rowspan="3">
                   <center> Modify</center></td>
                <td>
    <font color="#FFFFFF" size="+2">
    	
                    <asp:LinkButton ID="LinkButton7" runat="server" 
                        PostBackUrl="~/ModifyCategory.aspx">Category</asp:LinkButton>
     </font>
                </td>
            </tr>
            <tr>
    ...
    <font color="#FFFFFF" size="+2">
                    ...
                    <asp:LinkButton ID="LinkButton8" runat="server" 
                        PostBackUrl="~/ModifyBrand.aspx">Brand</asp:LinkButton>
     </font>
                </td>
            </tr>
            <tr>
    ...
    <font color="#FFFFFF" size="+2">
                    ...
                    <asp:LinkButton ID="LinkButton9" runat="server" 
                        PostBackUrl="~/ModifyProduct.aspx">Product</asp:LinkButton>
     </font>
                </td>
            </tr>
            <tr>
    ...
    <font color="#FFFFFF" size="+2">
                    ...
                    <asp:LinkButton ID="LinkButton10" runat="server" PostBackUrl="~/About.aspx">Manage Users</asp:LinkButton>
     </font>
                </td>
            </tr>
        </table>
