<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SignUp.aspx.cs" Inherits="user_AddNewUser" %>
...
<br />
        	...
        	<div class="col2">
                ...
                <div class="prlisting">
                <div>
                <h5 class="small_head">Add New User</h5>
                    <table width="100%">
                        <tr>
                            <td>&nbsp;
                                </td>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <table width="60%">
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label5" runat="server" Text="User ID" Font-Size="Larger"></asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label1" runat="server" Text="Name" Font-Size="Larger"></asp:Label>*
                                        </td>
                                        <td>
                                            <asp:TextBox ID="TextBox2" runat="server" Height="30px" Width="140px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label2" runat="server" Text="E-Mail" Font-Size="Larger"></asp:Label>*
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label3" runat="server" Text="Your Password" Font-Size="Larger"></asp:Label>*
                                        </td>
                                        <td>
                                            <asp:TextBox ID="TextBox5" runat="server" Height="30px" Width="140px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label6" runat="server" Text="Confirm Password" Font-Size="Larger"></asp:Label>*
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="Button2" runat="server" Text="Sign Up" Height="30px" 
    ...
    <div id="footer">
    	<div class="inner">
            ...
            <div class="footer_sec">
                ...
                <div class="footlogo">
                	<a href="index.html" class="small_logo"><img src="images/logo.png" alt="" /></a>
                    <h6>An Online Store</h6>
                </div>
                <div class="clear"></div>
                <div class="copyrights">

                	<p>Copyright ©2010 DUMY. All Rights Reserved</p>
