<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyProduct.aspx.cs" Inherits="ModifyProduct" %>
...
<div id="wrapper_sec">
    ...
    <font color="#FFFFFF" size="+2">
     ...
     <table class="style1">
            <tr>
                <td>
                   <br /><center>Modify Product</center><br /></td>
            </tr>
            <tr>
                <td>
                  <div style="background-color:#333;">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="purprice" HeaderText="Pur Price" 
