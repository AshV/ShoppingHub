<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewBrand.aspx.cs" Inherits="admin_AddNewBrand" %>
            ...
            <tr>
                <td colspan="2">
                    <table border="1">
                        <tr>
                            <td colspan="2">
                                 <br /><center>Add New Brand</center><br /> </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:Label ID="Label1" runat="server" Text="Brand ID"></asp:Label><br />
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label2" runat="server" Text="Brand Name"></asp:Label><br />
                            </td>
                            <td>
