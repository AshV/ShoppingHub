<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyCategory.aspx.cs" Inherits="ModifyCategory" %>
...
<div id="wrapper_sec">
    ...
    <font color="#FFFFFF" size="+2">
     ...
     <table class="style1">
            <tr>
                <td>
                   <br /><center>Modify Category</center><br /></td>
            </tr>
            <tr>
                <td>
                  <div style="background-color:#333;">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="catid" HeaderText="Id" SortExpression="catid" />
                            <asp:BoundField DataField="catname" HeaderText="Name" 
                                SortExpression="catname" />
                            <asp:BoundField DataField="catlink" HeaderText="Link" 
                                SortExpression="catlink" />
                            <asp:BoundField DataField="catimg" HeaderText="Image" 
                                SortExpression="catimg" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT * FROM [category]"></asp:SqlDataSource></div>
                   </td>
            </tr>
        </table>
