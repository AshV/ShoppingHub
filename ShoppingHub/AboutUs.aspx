...
<br />
        	...
        	<div class="col2">
                ...
                <div class="clear"></div>
                <!-- Product Listing -->
                <div class="prlisting"><br /><br /> 
                <font size="+3"><center>About Shopping HUB</center></font>
                <font size="+1"><br />
                &nbsp;&nbsp;&nbsp;
                    Shopping Hub is a form of electronic commerce which allows consumers to directly buy goods or services from a seller over the Internet using a web browser. Alternative names are: e-shop, e-store, Internet shop, web-shop, web-store, online store, and virtual store. An online shop evokes the physical analogy of buying products or services at a bricks-and-mortar retailer or shopping center; the process is called business-to-consumer (B2C) online shopping. In the case where a business buys from another business, the process is called business-to-business (B2B) online shopping.
                </font>
                </div>
            </div>
        </div>
